...
class WednesdayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        breakfastTxt.text = mealPref.getString("3breakfast", "")
        lunchTxt.text = mealPref.getString("3lunch", "")
        dinnerTxt.text = mealPref.getString("3dinner", "")
        dateTxt.text = mealPref.getString("3date", "")
