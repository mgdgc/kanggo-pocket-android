...
class TuesdayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        breakfastTxt.text = mealPref.getString("2breakfast", "")
        lunchTxt.text = mealPref.getString("2lunch", "")
        dinnerTxt.text = mealPref.getString("2dinner", "")
        dateTxt.text = mealPref.getString("2date", "")
