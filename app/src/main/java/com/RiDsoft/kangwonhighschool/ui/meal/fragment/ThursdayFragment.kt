...
class ThursdayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        breakfastTxt.text = mealPref.getString("4breakfast", "")
        lunchTxt.text = mealPref.getString("4lunch", "")
        dinnerTxt.text = mealPref.getString("4dinner", "")
        dateTxt.text = mealPref.getString("4date", "")
