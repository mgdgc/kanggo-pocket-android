...
class FridayFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        breakfastTxt.text = mealPref.getString("5breakfast", "")
        lunchTxt.text = mealPref.getString("5lunch", "")
        dinnerTxt.text = mealPref.getString("5dinner", "")
        dateTxt.text = mealPref.getString("5date", "")
